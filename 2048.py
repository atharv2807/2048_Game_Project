...
class Game2048(Frame):
	def __init__(self):
		...
		self.commands={c.KEY_UP:FinalLogic.move_up,
	...
	def init_grid(self):
		background=Frame(self,bg=c.BACKGROUND_COLOR_CELL_EMPTY,
		...
		for i in range(c.GRID_LEN):
			for j in range(c.GRID_LEN):
				...
				if new_number==0:
					...
					self.grid_cells[i][j].configure(text="new_number",
